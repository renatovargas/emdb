...
The [Policy Optimization Modelling Tool's (PolOpT)](https://openknowledge.fao.org/items/a9b06566-1128-4032-9c6e-203211f1d288) Emissions Database (EMDB) s an effort of the Monitoring and Analysing Food and Agricultural Policies (MAFAP) programme of the Agrifood Economics and Policy Division (ESA) of the Food and Agriculture Organization of the United Nations (FAO). It aims to provide a seamless integration of data on anthropogenic emissions of greenhouse gases and air pollution with National Accounts data at different levels of aggregation by economic activity to calibrate PolOpT. More generally, it can be used with environmentally extended structural analysis frameworks including Computable General Equilibrium and Input-Output models. Its main output is the database of anthropogenic emissions of greenhouse gases and air pollution by economic activity.
